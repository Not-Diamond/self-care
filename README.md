...
Self-Care is publicly available to use and explore, but it is not in active development. We will review bug reports and small fixes as time permits, but we are not actively accepting feature work or maintaining a public roadmap. See [CONTRIBUTING.md](./CONTRIBUTING.md) for details.
